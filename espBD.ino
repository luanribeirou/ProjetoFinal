...
char insert[] = "INSERT INTO monitortemp.historico (`TEMPI`, `TEMPE`, `UMII`, `UMIE`, `MEDIAI`, `MEDIAE`, `COLETA`) VALUES ('%d', '%d', '%d', '%d', '%d', '%d', CURRENT_TIMESTAMP);";
char query[128];
